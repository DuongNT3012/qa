package com.qrcode.barcode.barcodescanner.qrcodereader.ui.scan;
...
import com.qrcode.barcode.barcodescanner.qrcodereader.helpers.util.image.ImageInfo;
import com.qrcode.barcode.barcodescanner.qrcodereader.helpers.util.image.ImagePicker;
import com.qrcode.barcode.barcodescanner.qrcodereader.ui.pickedfromgallery.PickedFromGalleryActivity;
        ...
        switch (v.getId()) {
            case R.id.text_view_set_flash:
                ...
                Drawable flashIcon = ContextCompat.getDrawable(mContext,
                        mIsFlashOn ? R.drawable.ic_flash_off_2 : R.drawable.ic_flash_on_2);
                mTextViewFlash.setCompoundDrawablesWithIntrinsicBounds(flashIcon, null, null, null);
